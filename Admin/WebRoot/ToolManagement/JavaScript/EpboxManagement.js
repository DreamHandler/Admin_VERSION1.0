...
EpboxManagement.prototype = Object.extend(new LBase(), {
	...
	QryEpboxData : function(){
		...
		this.ajaxCall(QryJson,"Admin.ToolManagement.EpboxManagement","QryEpboxData",EpM.QryEpboxDataHandler,false);
	},
...
//				}
	...
	Epbox_btn_delete : function(){
		...
		var QryJson={"VBM":VBM};
		this.ajaxCall(QryJson,"Admin.ToolManagement.EpboxManagement","DeleteEpboxData",EpM.Epbox_btn_delete_handler,true);
	},
	...
	Epbox_btn_save : function(){
		...
		this.ajaxCall(QryJson,"Admin.ToolManagement.EpboxManagement","SaveEpboxData",EpM.Epbox_btn_save_handler,true);
	},
