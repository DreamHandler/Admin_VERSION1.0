...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		InitComprise(BassModuleUrl+"EpBox/EpBox.js"); //ep出现的位置还需要进一步验证计算方式，容易超出界面范围
		InitComprise(BassModuleUrl+"Dialog/LyDialog.js"); //无效
		InitComprise(BassModuleUrl+"Dialog/jQDialog.js"); 
