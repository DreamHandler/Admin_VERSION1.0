...
System_Menu.prototype = Object.extend(new LBase(), {
	...
	QrySystemData : function(){
		...
		this.ajaxCall(QryJson,"Admin.SystemMaintenance.System_Menu","QrySystemData",SM.QrySystemDataHandler,false);
	},
	QrySystemDataHandler : function(ajax){
		if (xmlObject.readyState == 4 && xmlObject.status == 200) {
			...
			var nodeJson = SM.XmlToJson(node);
	...
	system_btn_delete : function(){
		...
		this.ajaxCall(QryJson,"Admin.SystemMaintenance.System_Menu","DeleteSystemData",SM.system_btn_delete_handler,true);
	},
	...
	system_btn_save : function(){
		...
		this.ajaxCall(QryJson,"Admin.SystemMaintenance.System_Menu","SaveSystemData",SM.system_btn_save_handler,true);
	},
	...
	getTreeData : function(){
		...
		this.ajaxCall(QryJson,"Admin.SystemMaintenance.System_Menu","QryMenuData",SM.TreeDataHandler,false);
	},
	/**
     * 树形结构数据返回捕获
     */
	...
	menu_btn_save : function(){
		...
		this.ajaxCall(QryJson,"Admin.SystemMaintenance.System_Menu","SaveMenuData",SM.menu_btn_save_handler,true);
	},
	...
	qryMaxVnum : function(flag){
		...
		if(SM.New_Vnum != ""){ //已经查询过最大菜单编码，获取前台最大菜单编码
			...
			var QryJson={"VSYSNO":$("#system_VSYSNO").val()};
			this.ajaxCall(QryJson,"Admin.SystemMaintenance.System_Menu","QryMaxVnum",SM.qryMaxVnum_handler,true);
		}
	},
