...
RightManagement.prototype = Object.extend(new LBase(), {
			        ...
			        callback: {
			        	onClick : function(event, treeId, treeNode, clickFlag){
			        		...
			        		if(RM.IPARENTID != null && RM.IPARENTID != 0){
			        			...
			        			RM.ajaxCall(QryJson,"Admin.SystemMaintenance.RightManagement","QrySystemData",RM.SystemDataHandler,false);
			        		} else {//操作员组权限
	...
	SystemDataHandler : function(ajax){
		if (xmlObject.readyState == 4 && xmlObject.status == 200) {
			...
			if(node==null||node.xml===undefined){
				node = RM.StrToXml(response.responseText);
			}
	...
	getTreeData : function(){
		var QryJson={};
		RM.ajaxCall(QryJson,"Admin.SystemMaintenance.RightManagement","QryGroupAndUserData",RM.TreeDataHandler,false);
	},
	/**
     * 树形结构数据返回捕获
     */
	...
	Use_system_change : function(obj){
		...
		RM.ajaxCall(QryJson,"Admin.SystemMaintenance.RightManagement","QryMenuData",RM.Use_system_change_handler,false);
	},
	...
	getQX : function(){
		...
		RM.ajaxCall(QryJson,"Admin.SystemMaintenance.RightManagement","QryQX",RM.getQX_handler,false);
	},
...
//		$("#btn_left_all").each(function(i, n) {n.disabled = false;});
	...
	qx_btn_save  : function(){
		...
		RM.ajaxCall(QryJson,"Admin.SystemMaintenance.RightManagement","saveQX",RM.qx_btn_saveHandler,false);
	},
